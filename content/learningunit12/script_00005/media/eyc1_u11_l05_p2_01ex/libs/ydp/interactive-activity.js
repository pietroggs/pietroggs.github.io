(function (wnd) {
	...
	function clearAnimation() {
		...
		tailMC.reset();
		wing1MC.setTimeline([[0,'wing-closed']]);
		wing0MC.setTransforms({frame0:'translateZ(0px) rotateZ(-75deg) scaleX(-1)|0.01s'});
		wing0MC.reset();
	}
	...
	function setAnimation1() {
		...
		wing0MC.setTransforms({
			frame0:'translateZ(0px) rotateZ(-75deg) scaleX(-1)|0.1s'});
	}
	...
	function setAnimation2() {
		...
		wing0MC.setTransforms({
			frame0:'translateZ(0px) rotateZ(25deg) scaleX(-1)|0.2s', 
			frame24:'translateZ(0px) rotateZ(-75deg) scaleX(-1)|0.4s'});
	}
	...
	function setAnimation3() {
		...
		wing0MC.setTransforms({
			frame4:'translateZ(0px) rotateZ(25deg) scaleX(-1)|0.4s', 
			frame14:'translateZ(0px) rotateZ(55deg) scaleX(-1)|0.2s', 
			frame20:'translateZ(0px) rotateZ(25deg) scaleX(-1)|0.2s', 
			frame30:'translateZ(0px) rotateZ(-75deg) scaleX(-1)|0.2s'});
	}
